      ...
      <main className="min-h-screen bg-[#f5f7fb] text-slate-950">
        ...
        <section className="mx-auto w-full max-w-6xl px-4 pb-14 pt-8 sm:px-6 lg:px-8">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                <Link
                  ...
                  className="inline-flex h-9 items-center justify-center rounded-lg bg-blue-600 px-5 text-xs font-black text-white transition hover:bg-blue-700"
                >
                  Apply Now
                </Link>
                ...
                <Link
                  href={publicAuthLinks.login}
                  className="inline-flex h-10 items-center justify-center rounded-lg border border-blue-600 bg-white px-5 text-xs font-black text-blue-600 transition hover:bg-blue-50"
                >
                  Message
                </Link>
              </div>
          ...
          <section className="pt-8">
            ...
            <p className="mt-3 text-xs font-medium leading-6 text-slate-600 md:text-sm">
              {job.description}
            </p>
          </section>
          ...
          <section className="pt-8">
            ...
            <ul className="mt-3 list-disc space-y-1.5 pl-5 text-xs font-medium leading-6 text-slate-600 md:text-sm">
